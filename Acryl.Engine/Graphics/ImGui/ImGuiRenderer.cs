...
namespace Acryl.Engine.Graphics.ImGui
{
    ...
    public sealed class ImGuiRenderer
    {
        ...
        /// <summary>
        /// Creates a pointer to a texture, which can be passed through ImGui calls such as <see cref="System.Drawing.Image" />. That pointer is then used by ImGui to let us know what texture to draw
        /// </summary>
